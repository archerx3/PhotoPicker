//
//  AWAssetPreviewViewController.swift
//  PhotoPicker
//
//  Created by archer.chen on 8/20/20.
...
open class AWAssetPreviewViewController: UIViewController {
...
private extension AWAssetPreviewViewController {
    func setupViews() {
