//
//  AWPhotoCollectionViewCell.swift
//  PhotoPicker
//
...
open class AWPlayerView: UIView {
...
open class AWPhotoCollectionViewCell: UICollectionViewCell {
    private var observer: NSObjectProtocol?
    @IBOutlet open var imageView: UIImageView?
    @IBOutlet open var playerView: AWPlayerView?
    ...
    deinit {
        //        print("deinit AWPhotoCollectionViewCell")
    }
