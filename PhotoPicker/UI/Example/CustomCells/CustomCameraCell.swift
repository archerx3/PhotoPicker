...
@available(iOS 10.2, *)
class CustomCameraCell: AWPhotoCollectionViewCell, AVCaptureFileOutputRecordingDelegate {
    ...
    @IBOutlet private weak var previewView: AWPreviewView!
    ...
    var inProgressPhotoCaptureDelegates = [Int64: AWPhotoCaptureProcessor]()
    ...
    override func selectedCell() {
        ...
        sessionQueue.async {
            ...
            let photoCaptureProcessor = AWPhotoCaptureProcessor(with: photoSettings, willCapturePhotoAnimation: {
                DispatchQueue.main.async {
